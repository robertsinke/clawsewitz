...
10. **Invoke `challenger` agent in Premortem mode** with the act artefact + decide + intake. Append the "six months from now, this failed" narrative and risk extractions to `07-act.md`. Update the plan with any additions the pre-mortem motivates (e.g. a week-8 checkpoint to test a named assumption).
