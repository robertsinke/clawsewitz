...
argument-hint: "<path to strategy/plan document>"
---
...
**Load the analyst discipline.** Read `${CLAUDE_PLUGIN_ROOT}/references/analyst-discipline.md`. Surface assumptions, keep it surgical, drive to verifiable goals.
