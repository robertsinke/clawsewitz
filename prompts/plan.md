...
args: recommendation or decision to implement
...
2. **Load the analyst discipline.** Read `references/analyst-discipline.md`. Plans that ignore what can go wrong are plans that fail.
