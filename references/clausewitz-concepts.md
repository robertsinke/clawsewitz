...
## Strategy serves policy

**Source:** On War, Book I, Chapter 1 — *"War is merely the continuation of policy by other means."*

**Original:** Military means are subordinate to political ends. A campaign that wins on the field but fails the political objective has failed.
...
**Source:** On War, Book I, Chapter 1 — the "remarkable trinity" of passion, chance, and reason.

**Original:** Three forces shape every campaign: (a) **the people** — primordial passion, hatred, and will; (b) **the army** — the play of chance and probability, where creativity lives; (c) **the government** — reason and policy.
...
**Source:** On War, Book VIII, Chapter 4 — *"the hub of all power and movement, upon which everything depends."*

**Original:** In every adversary and every conflict, there is a center of gravity — the source of strength. A blow against the Schwerpunkt cascades; a blow anywhere else is wasted force.
...
**Source:** On War, Book I, Chapter 7 — *"Everything is very simple in war, but the simplest thing is difficult."*

**Original:** Countless small things — a slow horse, a misread order, rain, fatigue — accumulate into a force that drags every plan toward failure. Friction is the difference between war on paper and war in reality.
...
**Source:** On War, Book II, Chapter 2 — the "fog" in which commanders must decide on incomplete information.

**Original:** "War is the realm of uncertainty; three-quarters of the factors on which action is based are wrapped in a fog of greater or lesser uncertainty."
...
**Source:** On War, Book VII, Chapter 5 — the point at which an offensive, if continued, yields less than it costs.

**Original:** Every offensive reaches a point where the attacker's strength no longer exceeds the defender's resistance plus the cost of continued advance. Beyond it, continued attack is worse than halting.
...
**Source:** A modern American staff-college formulation of Clausewitz's strategy triad; grounded in *On War* Book III.

**Original:** Strategy connects desired **ends** (objectives), selected **ways** (approaches), and available **means** (resources). A valid strategy has all three and they cohere; a recommendation missing one is not yet a strategy.
...
**Source:** On War, Book III, Chapter 3 — *"Physical quantity is only the wooden handle; the moral is the real weapon."*

**Original:** Morale, leadership, will, training, cohesion — the non-material forces — are not secondary to physical strength. They are often decisive. Armies equal on paper are unequal in fact.
...
**Source:** On War, Book III, Chapter 6 — *"A distinguished commander without boldness is unthinkable."*

**Original:** Boldness is the "noble virtue" of the commander. Brilliance without audacity produces timid plans. Intelligence unattended by boldness loses to mediocrity coupled with decisiveness.
...
**Source:** On War, Book III, Chapter 12.

**Original:** The commander who commits every soldier at the start cannot respond to the unknown. Reserves exist precisely because plans encounter friction; the forces kept back are what win the decisive moment.
...
**Source:** On War, Book VI, Chapter 1 — *"Defense is the stronger form of waging war."*

**Original:** Counter-intuitively, defense requires less force than attack to achieve the same end. The defender knows the ground, chooses the timing, and fights with cheaper logistics. Offense is the stronger form of *intent* — you cannot win purely on defense — but defense is the cheaper form of *execution*.
...
**Source:** On War, Book I, Chapter 3 — the "inward eye" that grasps the truth of a situation at a glance.

**Original:** *Coup d'œil* — literally "stroke of the eye" — is the commander's capacity to see, through fog and friction, the essence of the situation and the right action, faster than deliberate analysis could produce it.
